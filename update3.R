...
/* Professional Interface - Optimized Zoom (95% equivalent) */
:root {
  --hopkins-blue: #002D72;
...
/* Subtle container scaling for zoom-out effect */
.container-fluid {
  padding-left: 0;
  padding-right: 0;
  max-width: 1350px;
...
.process-step {
  position: relative;
  padding: 1.2rem 1.2rem 1.2rem 70px;
  margin-bottom: 1rem;
  background: white;
  border-radius: 8px;
