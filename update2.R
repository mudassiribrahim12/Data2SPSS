...
convert_to_other_format <- function(data, target_format, file_path) {
  tryCatch({
    # Prepare data for export - handle large datasets efficiently
...
ui <- fluidPage(
  ...
  div(class = "blog-header",
      div(class = "blog-header-content",
          ...
          p(class = "app-tagline", 
            "Transform your research data between SPSS, Stata, Excel, SAS, R, and more with intelligent variable detection")
      )
  ),
  ...
  div(class = "container-fluid",
      ...
      tabsetPanel(
                  ...
                  div(class = "guide-section",
                      ...
                      div(class = "guide-step",
                          ...
                          div(class = "step-content",
                              h4("Load Your Data"),
                              p("Upload any data file. The tool supports multiple formats:"),
                              tags$ul(
                                tags$li("SPSS (.sav), Stata (.dta), SAS (.sas7bdat)"),
                                tags$li("Excel (.xlsx, .xls), CSV, TSV, TXT"),
                                tags$li("R Data (.rdata)")
                              )
                          )
                      ),
                      ...
                      div(class = "guide-step",
                          ...
                          div(class = "step-content",
                              h4("Choose Your Output"),
                              p("Select your desired output format:"),
                              tags$ul(
                                tags$li("SPSS (.sav) with proper measure types and value labels"),
                                tags$li("Excel, CSV, Stata, SAS, RData for cross-platform analysis"),
                                tags$li("All conversions preserve variable labels and value labels")
                              )
                          )
                      ),
                      ...
                      div(class = "guide-step",
                          ...
                          div(class = "step-content",
                              h4("Convert & Download"),
                              p("Click convert, preview your data, and download the file ready for analysis in your preferred software.")
                          )
                      ),
                      
                      div(class = "important-note",
                          h4("💡 Important Note About the Tool"),
                          p("Although the app name is Data2SPSS, this tool handles ALL major data formats. You can convert SPSS to Stata, Stata to Excel, SAS to CSV, and any combination. The tool intelligently preserves value labels, variable names, and metadata across all conversions.")
                      )
                  ),
              ...
              div(class = "blog-card",
                  ...
                  div(class = "process-steps",
                      div(class = "process-step",
                          h4("Import Your Data"),
                          p("Start by importing your data file in the 'Data Converter' tab. Supported formats include: SPSS, Stata, Excel, CSV, SAS, RData, and more.")
                      ),
                      
                      div(class = "process-step",
                          h4("Convert to SPSS (or Other Format)"),
                          p("Use the 'Data Converter' tab for SPSS output, or the 'Export to Other Formats' tab for converting to Stata, Excel, SAS, CSV, and more.")
                      ),
                      
                      div(class = "process-step",
                          h4("Download Your File"),
                          p("Download the converted data in your chosen format, ready for statistical analysis.")
                      ),
                      
                      div(class = "process-step",
                          h4("Analyze Your Data"),
                          p("Your data is now ready for analysis with proper variable types and value labels preserved.")
                      )
                  ),
                  
                  div(class = "info-box",
                      h4("Technical Note"),
                      p("The tool automatically handles variable name cleaning, value label generation, and measure type assignment. All categorical variables are properly labeled, while continuous variables remain as numeric. The tool can handle datasets of any size, limited only by your system's available memory.")
                  )
              )
          )
        ),
        ...
        # Tab 3: Export to Other Formats (Bidirectional Conversion)
        tabPanel(
                  ...
                  conditionalPanel(
                    ...
                    div(class = "conversion-section",
                        ...
                        div(class = "step-box",
                            ...
                            p("For SAS export: The file is saved in .sas7bdat format which can be opened in SAS, JMP, and other SAS-compatible software.")
                        ),
...
server <- function(input, output, session) {
  ...
  # NEW: Convert to other format (bidirectional) - FIXED for Excel and SAS
